...
const LICENSES = ['Starter', 'Business', 'Premium'];
      ...
      <Stack spacing={5}>
        ...
        <Stack spacing={2.5}>
          <Stack spacing={1.5} direction="row" alignItems="center">
            ...
            <Typography variant="body2">pkgID: {plan.pkg}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">Price: ${plan.Sale_price}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">Disk Size: {plan.Disk}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">Bandwidth: {plan.BandWidth}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">Email: {plan.Email}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">TLD: {plan.TLD}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">CPU: {plan.CPU}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">SQL Database: {plan.My_sql_db}</Typography>
          </Stack>
          <Stack spacing={1.5} direction="row" alignItems="center">
            <Box component={Icon} icon={checkmarkFill} sx={{ color: 'primary.main', width: 20, height: 20 }} />
            <Typography variant="body2">Free SSL: {plan.Free_ssl}</Typography>
          </Stack>
