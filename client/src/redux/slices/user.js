...
export function getCards() {
  ...
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get(`/api/get-cards/${decode.id}`);
...
export function addCards(data) {
  ...
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.post(`/api/add-card/${decode.id}`, data);
      dispatch(slice.actions.addCardsSuccess(response.data.cards));
    } catch (error) {
      dispatch(slice.actions.hasError(error));
    }
  };
...
export function updatePassword(data) {
  ...
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.post(`/api/update-password/${decode.id}`, data);
      dispatch(slice.actions.updatePasswordSuccess(response.data.message));
    } catch (error) {
...
export function getPlan() {
  ...
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get(`/api/plan/getplan/${decode.id}`);
